...
/* Generated by Opal 0.11.4 */
Opal.modules["opal/jquery/local_storage"] = function(Opal) {
  ...
  (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var self = $LocalStorage = $klass($base, $super, 'LocalStorage', $LocalStorage);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_LocalStorage_initialize_1, TMP_LocalStorage_$$$eq_2, TMP_LocalStorage_$$_3, TMP_LocalStorage_delete_4, TMP_LocalStorage_clear_5;

      def.storage = nil;
      
      
      Opal.defn(self, '$initialize', TMP_LocalStorage_initialize_1 = function $$initialize(storage) {
        var self = this;

        return (self.storage = storage)
      }, TMP_LocalStorage_initialize_1.$$arity = 1);
      
      Opal.defn(self, '$[]=', TMP_LocalStorage_$$$eq_2 = function(key, value) {
        var self = this;
      ...
      }, TMP_LocalStorage_$$$eq_2.$$arity = 2);
      
      Opal.defn(self, '$[]', TMP_LocalStorage_$$_3 = function(key) {
        var self = this;
      ...
      }, TMP_LocalStorage_$$_3.$$arity = 1);
      
      Opal.defn(self, '$delete', TMP_LocalStorage_delete_4 = function(key) {
        var self = this;

        return self.storage.removeItem(key)
      }, TMP_LocalStorage_delete_4.$$arity = 1);
      return (Opal.defn(self, '$clear', TMP_LocalStorage_clear_5 = function $$clear() {
        var self = this;

        return self.storage.clear()
      }, TMP_LocalStorage_clear_5.$$arity = 0), nil) && 'clear';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
  return Opal.const_set($nesting[0], 'LocalStorage', Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Browser'), 'LocalStorage').$new(window.localStorage));
};
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$ready?', '$height', '$width', '$now', '$+', '$-', '$sec', '$*', '$%', '$min', '$day', '$hour', '$find', '$[]', '$value=', '$css', '$/', '$==', '$strftime', '$text=', '$on', '$forward_url', '$text', '$element', '$to_i', '$id', '$>', '$get_from', '$get_to', '$alert', '$value', '$[]=', '$include?', '$sms_message', '$new', '$year', '$month']);
  ...
  return $send(Opal.const_get_relative($nesting, 'Document'), 'ready?', [], (TMP_1 = function(){var self = TMP_1.$$s || this, $a, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9, TMP_forward_url_10, TMP_sms_message_11, TMP_get_from_12, TMP_get_to_13, time = nil, $writer = nil;
    if (self.time_from == null) self.time_from = nil;
    if (self.time_to == null) self.time_to = nil;
    if (self.width == null) self.width = nil;
    if (self.height == null) self.height = nil;
    if (self.day_to == null) self.day_to = nil;
    if (self.day_from == null) self.day_from = nil;
    if (self.hour_from == null) self.hour_from = nil;
    if (self.min_from == null) self.min_from = nil;
    if (self.hour_to == null) self.hour_to = nil;
    if (self.min_to == null) self.min_to = nil;

  
    self.height = Opal.const_get_relative($nesting, 'Document').$height();
    self.width = Opal.const_get_relative($nesting, 'Document').$width();
    time = Opal.const_get_relative($nesting, 'Time').$now();
    self.time_from = $rb_plus($rb_minus($rb_minus(time, time.$sec()), $rb_times(time.$min()['$%'](15), 60)), $rb_times(15, 60));
    self.day_from = self.time_from.$day();
    self.hour_from = self.time_from.$hour();
    self.min_from = self.time_from.$min();
    self.time_to = $rb_plus(self.time_from, $rb_times(60, 60));
    self.day_to = self.time_to.$day();
    self.hour_to = self.time_to.$hour();
    self.min_to = self.time_to.$min();
    self.debug = Opal.const_get_relative($nesting, 'Element').$find("#debug_info");
    
    $writer = [($truthy($a = Opal.const_get_relative($nesting, 'LocalStorage')['$[]']("tel")) ? $a : "07860055401")];
    ...
    $writer[$rb_minus($writer["length"], 1)];;
    Opal.const_get_relative($nesting, 'Element').$find("#tel").$css("font-size", "" + ($rb_divide(self.width, 16)) + "px");
    Opal.const_get_relative($nesting, 'Element').$find("#tel").$css("width", "" + ($rb_divide(self.width, 2)) + "px");
    Opal.const_get_relative($nesting, 'Element').$find("#pin").$css("font-size", "" + ($rb_divide(self.width, 16)) + "px");
    ...
    $writer = [$rb_plus(Opal.const_get_relative($nesting, 'Time').$now(), $rb_times($rb_times($rb_times(2, 60), 60), 24)).$strftime("%A")];
    $send(Opal.const_get_relative($nesting, 'Element').$find("#fd2"), 'text=', Opal.to_a($writer));
    $writer[$rb_minus($writer["length"], 1)];;
    
    $writer = [$rb_plus(Opal.const_get_relative($nesting, 'Time').$now(), $rb_times($rb_times($rb_times(3, 60), 60), 24)).$strftime("%A")];
    $send(Opal.const_get_relative($nesting, 'Element').$find("#fd3"), 'text=', Opal.to_a($writer));
    $writer[$rb_minus($writer["length"], 1)];;
    
    $writer = [$rb_plus(Opal.const_get_relative($nesting, 'Time').$now(), $rb_times($rb_times($rb_times(2, 60), 60), 24)).$strftime("%A")];
    $send(Opal.const_get_relative($nesting, 'Element').$find("#td2"), 'text=', Opal.to_a($writer));
    $writer[$rb_minus($writer["length"], 1)];;
    
    $writer = [$rb_plus(Opal.const_get_relative($nesting, 'Time').$now(), $rb_times($rb_times($rb_times(3, 60), 60), 24)).$strftime("%A")];
    $send(Opal.const_get_relative($nesting, 'Element').$find("#td3"), 'text=', Opal.to_a($writer));
    $writer[$rb_minus($writer["length"], 1)];;
    $send(Opal.const_get_relative($nesting, 'Element').$find(".quick"), 'on', ["click"], (TMP_2 = function(event){var self = TMP_2.$$s || this;
if (event == null) event = nil;
    return self.$forward_url(event.$element().$text())}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2));
    Opal.const_get_relative($nesting, 'Element').$find("#fd0").$css("background-color", Opal.const_get_relative($nesting, 'ACTIVE_COLOUR'));
    Opal.const_get_relative($nesting, 'Element').$find("" + "#fh" + (self.hour_from)).$css("background-color", Opal.const_get_relative($nesting, 'ACTIVE_COLOUR'));
    Opal.const_get_relative($nesting, 'Element').$find("" + "#fm" + (self.min_from)).$css("background-color", Opal.const_get_relative($nesting, 'ACTIVE_COLOUR'));
    Opal.const_get_relative($nesting, 'Element').$find("#td0").$css("background-color", Opal.const_get_relative($nesting, 'ACTIVE_COLOUR'));
    Opal.const_get_relative($nesting, 'Element').$find("" + "#th" + (self.hour_to)).$css("background-color", Opal.const_get_relative($nesting, 'ACTIVE_COLOUR'));
    Opal.const_get_relative($nesting, 'Element').$find("" + "#tm" + (self.min_to)).$css("background-color", Opal.const_get_relative($nesting, 'ACTIVE_COLOUR'));
    $send(Opal.const_get_relative($nesting, 'Element').$find(".fd"), 'on', ["click"], (TMP_3 = function(event){var self = TMP_3.$$s || this;
      if (self.d_from == null) self.d_from = nil;
if (event == null) event = nil;
    
      Opal.const_get_relative($nesting, 'Element').$find("" + "#fd" + (self.d_from)).$css("background-color", Opal.const_get_relative($nesting, 'INACTIVE_COLOUR'));
      event.$element().$css("background-color", Opal.const_get_relative($nesting, 'ACTIVE_COLOUR'));
      return (self.d_from = event.$element().$id()['$[]'](2).$to_i());}, TMP_3.$$s = self, TMP_3.$$arity = 1, TMP_3));
    $send(Opal.const_get_relative($nesting, 'Element').$find(".fh"), 'on', ["click"], (TMP_4 = function(event){var self = TMP_4.$$s || this;
      if (self.hour_from == null) self.hour_from = nil;
if (event == null) event = nil;
    
      Opal.const_get_relative($nesting, 'Element').$find("" + "#fh" + (self.hour_from)).$css("background-color", Opal.const_get_relative($nesting, 'INACTIVE_COLOUR'));
      event.$element().$css("background-color", Opal.const_get_relative($nesting, 'ACTIVE_COLOUR'));
      return (self.hour_from = event.$element().$text());}, TMP_4.$$s = self, TMP_4.$$arity = 1, TMP_4));
    $send(Opal.const_get_relative($nesting, 'Element').$find(".fm"), 'on', ["click"], (TMP_5 = function(event){var self = TMP_5.$$s || this;
      if (self.min_from == null) self.min_from = nil;
if (event == null) event = nil;
    
      Opal.const_get_relative($nesting, 'Element').$find("" + "#fm" + (self.min_from)).$css("background-color", Opal.const_get_relative($nesting, 'INACTIVE_COLOUR'));
      event.$element().$css("background-color", Opal.const_get_relative($nesting, 'ACTIVE_COLOUR'));
      return (self.min_from = event.$element().$text());}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5));
    $send(Opal.const_get_relative($nesting, 'Element').$find(".td"), 'on', ["click"], (TMP_6 = function(event){var self = TMP_6.$$s || this;
      if (self.d_to == null) self.d_to = nil;
if (event == null) event = nil;
    
      Opal.const_get_relative($nesting, 'Element').$find("" + "#td" + (self.d_to)).$css("background-color", Opal.const_get_relative($nesting, 'INACTIVE_COLOUR'));
      event.$element().$css("background-color", Opal.const_get_relative($nesting, 'ACTIVE_COLOUR'));
      return (self.d_to = event.$element().$id()['$[]'](2).$to_i());}, TMP_6.$$s = self, TMP_6.$$arity = 1, TMP_6));
    $send(Opal.const_get_relative($nesting, 'Element').$find(".th"), 'on', ["click"], (TMP_7 = function(event){var self = TMP_7.$$s || this;
      if (self.hour_to == null) self.hour_to = nil;
if (event == null) event = nil;
    
      Opal.const_get_relative($nesting, 'Element').$find("" + "#th" + (self.hour_to)).$css("background-color", Opal.const_get_relative($nesting, 'INACTIVE_COLOUR'));
      event.$element().$css("background-color", Opal.const_get_relative($nesting, 'ACTIVE_COLOUR'));
      return (self.hour_to = event.$element().$text());}, TMP_7.$$s = self, TMP_7.$$arity = 1, TMP_7));
    $send(Opal.const_get_relative($nesting, 'Element').$find(".tm"), 'on', ["click"], (TMP_8 = function(event){var self = TMP_8.$$s || this;
      if (self.min_to == null) self.min_to = nil;
if (event == null) event = nil;
    
      Opal.const_get_relative($nesting, 'Element').$find("" + "#tm" + (self.min_to)).$css("background-color", Opal.const_get_relative($nesting, 'INACTIVE_COLOUR'));
      event.$element().$css("background-color", Opal.const_get_relative($nesting, 'ACTIVE_COLOUR'));
      return (self.min_to = event.$element().$text());}, TMP_8.$$s = self, TMP_8.$$arity = 1, TMP_8));
    $send(Opal.const_get_relative($nesting, 'Element').$find(".book"), 'on', ["click"], (TMP_9 = function(event){var self = TMP_9.$$s || this;
if (event == null) event = nil;
    return self.$forward_url(event.$element().$text())}, TMP_9.$$s = self, TMP_9.$$arity = 1, TMP_9));
    
    Opal.def(self, '$forward_url', TMP_forward_url_10 = function $$forward_url(code) {
      var self = this, tel = nil, $writer = nil, pin = nil, url = nil;

      if ($truthy($rb_gt(self.$get_from(), self.$get_to()))) {
        return self.$alert("FROM time is after TO time.")
        } else {
    ...
    }, TMP_forward_url_10.$$arity = 1);
    
    Opal.def(self, '$sms_message', TMP_sms_message_11 = function $$sms_message() {
      var self = this;

      return "" + (self.$get_from().$strftime("%d%m%y")) + " " + (self.$get_from().$strftime("%H%M")) + " " + (self.$get_to().$strftime("%d%m%y")) + " " + (self.$get_to().$strftime("%H%M"))
    }, TMP_sms_message_11.$$arity = 0);
    
    Opal.def(self, '$get_from', TMP_get_from_12 = function $$get_from() {
      var self = this, ft = nil;
      if (self.time_from == null) self.time_from = nil;
      if (self.d_from == null) self.d_from = nil;
      if (self.hour_from == null) self.hour_from = nil;
      if (self.min_from == null) self.min_from = nil;
      ...
      ft = $rb_plus(self.time_from, $rb_times($rb_times($rb_times(self.d_from, 24), 60), 60));
      return Opal.const_get_relative($nesting, 'Time').$new(ft.$year(), ft.$month(), ft.$day(), self.hour_from, self.min_from);
    }, TMP_get_from_12.$$arity = 0);
    return (Opal.def(self, '$get_to', TMP_get_to_13 = function $$get_to() {
      var self = this, ft = nil;
      if (self.time_from == null) self.time_from = nil;
      if (self.d_to == null) self.d_to = nil;
      if (self.hour_to == null) self.hour_to = nil;
      ...
      ft = $rb_plus(self.time_from, $rb_times($rb_times($rb_times(self.d_to, 24), 60), 60));
      return Opal.const_get_relative($nesting, 'Time').$new(ft.$year(), ft.$month(), ft.$day(), self.hour_to, self.min_to);
    }, TMP_get_to_13.$$arity = 0), nil) && 'get_to';}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1));
})(Opal);
