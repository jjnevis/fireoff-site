...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$ready?', '$height', '$width', '$find', '$+', '$text=', '$-', '$css', '$/', '$on', '$forward_url']);
  
  self.$require("opal-jquery");
  return $send(Opal.const_get_relative($nesting, 'Document'), 'ready?', [], (TMP_1 = function(){var self = TMP_1.$$s || this, TMP_2, TMP_3, TMP_forward_url_4, header = nil, $writer = nil;
