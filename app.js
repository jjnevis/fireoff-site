...
Opal.modules["native"] = function(Opal) {
  ...
  (function($base, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Native_is_a$q_1, TMP_Native_try_convert_2, TMP_Native_convert_3, TMP_Native_call_4, TMP_Native_proc_5, TMP_Native_included_22;
...
if (value == null) value = nil;
          ...
          return $send(self, 'define_method', [new$], (TMP_9 = function($a_rest){var self = TMP_9.$$s || this, block, args, value = nil;
            ...
            value = $send(Opal.const_get_relative($nesting, 'Native'), 'call', [self["native"], old].concat(Opal.to_a(args)), block.$to_proc());
            if ($truthy(value)) {
...
if (value == null) value = nil;
    ...
    (function($base, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Wrapper_initialize_19, TMP_Wrapper_to_n_20, TMP_Wrapper_included_21;
    ...
    Opal.defs(self, '$included', TMP_Native_included_22 = function $$included(base) {
      ...
      base.$include(Opal.const_get_relative($nesting, 'Wrapper'));
      return base.$extend(Opal.const_get_relative($nesting, 'Helpers'));
    }, TMP_Native_included_22.$$arity = 1);
  })($nesting[0], $nesting);
  (function($base, $parent_nesting) {
    var $Kernel, self = $Kernel = $module($base, 'Kernel');

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Kernel_native$q_23, TMP_Kernel_Native_26, TMP_Kernel_Array_27;
...
if (o == null) o = nil;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Array_initialize_43, TMP_Array_each_44, TMP_Array_$$_45, TMP_Array_$$$eq_46, TMP_Array_last_47, TMP_Array_length_48, TMP_Array_inspect_49;

    def.named = def["native"] = def.get = def.block = def.set = def.length = nil;
    
    self.$include(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Native'), 'Wrapper'));
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Numeric_to_n_50;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Proc_to_n_51;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_String_to_n_52;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Regexp_to_n_53;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_MatchData_to_n_54;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Struct_to_n_56;
...
if (name == null) name = nil;if (value == null) value = nil;
      return result[name] = Opal.const_get_relative($nesting, 'Native').$try_convert(value, value)}, TMP_55.$$s = self, TMP_55.$$arity = 2, TMP_55));
      return result;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Array_to_n_57;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Boolean_to_n_58;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Time_to_n_59;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_NilClass_to_n_60;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Hash_initialize_61, TMP_Hash_to_n_62;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Module_native_module_63;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Class_native_alias_64, TMP_Class_native_class_65;
...
if (method == null) method = nil;
    ...
    Opal.def(self, '$prop', TMP_Element_prop_8 = function $$prop($a_rest) {
      var self = this, args;
    ...
    Opal.def(self, '$to_n', TMP_Element_to_n_9 = function $$to_n() {
      var self = this;

      return self
    }, TMP_Element_to_n_9.$$arity = 0);
    
    Opal.def(self, '$[]', TMP_Element_$$_10 = function(name) {
      var self = this;
    ...
    Opal.def(self, '$[]=', TMP_Element_$$$eq_11 = function(name, value) {
      var self = this;
    ...
    Opal.def(self, '$attr', TMP_Element_attr_12 = function $$attr($a_rest) {
      ...
      case 1:
        ...
        break;
      case 2:
        return (($writer = [args[0], args[1]]), $send(self, '[]=', Opal.to_a($writer)), $writer[$rb_minus($writer["length"], 1)]);
        break;
      default:
    ...
    Opal.def(self, '$has_attribute?', TMP_Element_has_attribute$q_13 = function(name) {
      var self = this;

      return self.attr(name) !== undefined;
    }, TMP_Element_has_attribute$q_13.$$arity = 1);
    
    Opal.def(self, '$append_to_body', TMP_Element_append_to_body_14 = function $$append_to_body() {
      var self = this;

      return self.appendTo(document.body);
    }, TMP_Element_append_to_body_14.$$arity = 0);
    
    Opal.def(self, '$append_to_head', TMP_Element_append_to_head_15 = function $$append_to_head() {
      var self = this;

      return self.appendTo(document.head);
    }, TMP_Element_append_to_head_15.$$arity = 0);
    
    Opal.def(self, '$at', TMP_Element_at_16 = function $$at(index) {
      var self = this;
    ...
    Opal.def(self, '$class_name', TMP_Element_class_name_17 = function $$class_name() {
      var self = this;
    ...
    Opal.def(self, '$class_name=', TMP_Element_class_name$eq_18 = function(name) {
      var self = this;
    ...
    Opal.def(self, '$css', TMP_Element_css_19 = function $$css(name, value) {
      var $a, self = this;
    ...
    Opal.def(self, '$animate', TMP_Element_animate_20 = function $$animate(params) {
    ...
    Opal.def(self, '$data', TMP_Element_data_21 = function $$data($a_rest) {
      var self = this, args;
    ...
    Opal.def(self, '$effect', TMP_Element_effect_22 = function $$effect(name, $a_rest) {
...
if (a == null) a = nil;
    ...
    Opal.def(self, '$visible?', TMP_Element_visible$q_25 = function() {
      var self = this;

      return self.is(':visible');
    }, TMP_Element_visible$q_25.$$arity = 0);
    
    Opal.def(self, '$offset', TMP_Element_offset_26 = function $$offset() {
      var self = this;

      return self.$Native(self.offset())
    }, TMP_Element_offset_26.$$arity = 0);
    
    Opal.def(self, '$each', TMP_Element_each_27 = function $$each() {
    ...
    Opal.def(self, '$first', TMP_Element_first_28 = function $$first() {
      var self = this;

      return self.length ? self.first() : nil;
    }, TMP_Element_first_28.$$arity = 0);
    
    Opal.def(self, '$html', TMP_Element_html_29 = function $$html(content) {
      var self = this;
    ...
    Opal.def(self, '$id=', TMP_Element_id$eq_31 = function(id) {
      var self = this;
    ...
    Opal.def(self, '$tag_name', TMP_Element_tag_name_32 = function $$tag_name() {
      var self = this;

      return self.length > 0 ? self[0].tagName.toLowerCase() : nil
    }, TMP_Element_tag_name_32.$$arity = 0);
    
    Opal.def(self, '$inspect', TMP_Element_inspect_33 = function $$inspect() {
      var self = this;
    ...
    Opal.def(self, '$to_s', TMP_Element_to_s_34 = function $$to_s() {
      var self = this;
    ...
    Opal.def(self, '$length', TMP_Element_length_35 = function $$length() {
      var self = this;

      return self.length;
    }, TMP_Element_length_35.$$arity = 0);
    
    Opal.def(self, '$any?', TMP_Element_any$q_36 = function() {
      var self = this;

      return self.length > 0;
    }, TMP_Element_any$q_36.$$arity = 0);
    
    Opal.def(self, '$empty?', TMP_Element_empty$q_37 = function() {
      var self = this;
    ...
    Opal.def(self, '$on', TMP_Element_on_38 = function $$on(name, sel) {
    ...
    Opal.def(self, '$one', TMP_Element_one_39 = function $$one(name, sel) {
    ...
    Opal.def(self, '$off', TMP_Element_off_40 = function $$off(name, sel, block) {
      var self = this;
    ...
    Opal.def(self, '$serialize_array', TMP_Element_serialize_array_42 = function $$serialize_array() {
...
if (e == null) e = nil;
    ...
    Opal.def(self, '$value', TMP_Element_value_43 = function $$value() {
      var self = this;

      return self.val() || "";
    }, TMP_Element_value_43.$$arity = 0);
    
    Opal.def(self, '$height', TMP_Element_height_44 = function $$height() {
      var self = this;

      return self.height() || nil;
    }, TMP_Element_height_44.$$arity = 0);
    
    Opal.def(self, '$width', TMP_Element_width_45 = function $$width() {
      var self = this;

      return self.width() || nil;
    }, TMP_Element_width_45.$$arity = 0);
    
    Opal.def(self, '$position', TMP_Element_position_46 = function $$position() {
      var self = this;

      return self.$Native(self.position())
    }, TMP_Element_position_46.$$arity = 0);
    
    Opal.def(self, '$==', TMP_Element_$eq$eq_47 = function(other) {
      var self = this;

      return self.is(other);
    }, TMP_Element_$eq$eq_47.$$arity = 1);
    
    Opal.def(self, '$respond_to_missing?', TMP_Element_respond_to_missing$q_48 = function(name, _) {
    ...
    return (Opal.def(self, '$method_missing', TMP_Element_method_missing_49 = function $$method_missing(name, $a_rest) {
...
Opal.modules["opal/jquery/window"] = function(Opal) {
  ...
  (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      Opal.def(self, '$element', TMP_Window_element_1 = function $$element() {
        var $a, self = this;
      ...
      Opal.def(self, '$on', TMP_Window_on_2 = function $$on($a_rest) {
      ...
      Opal.def(self, '$off', TMP_Window_off_3 = function $$off($a_rest) {
      ...
      return (Opal.def(self, '$trigger', TMP_Window_trigger_4 = function $$trigger($a_rest) {
        var self = this, args;
...
Opal.modules["opal/jquery/document"] = function(Opal) {
  ...
  (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      Opal.def(self, '$ready?', TMP_DocumentMethods_ready$q_1 = function() {
      ...
      Opal.def(self, '$ready', TMP_DocumentMethods_ready_3 = function $$ready() {
      ...
      Opal.def(self, '$title', TMP_DocumentMethods_title_5 = function $$title() {
        var self = this;

        return document.title;
      }, TMP_DocumentMethods_title_5.$$arity = 0);
      
      Opal.def(self, '$title=', TMP_DocumentMethods_title$eq_6 = function(title) {
        var self = this;

        return document.title = title;
      }, TMP_DocumentMethods_title$eq_6.$$arity = 1);
      
      Opal.def(self, '$head', TMP_DocumentMethods_head_7 = function $$head() {
        var self = this;

        return Opal.const_get_relative($nesting, 'Element').$find(document.head)
      }, TMP_DocumentMethods_head_7.$$arity = 0);
      
      Opal.def(self, '$body', TMP_DocumentMethods_body_8 = function $$body() {
        var self = this;
...
Opal.modules["opal/jquery/event"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$initialize', TMP_Event_initialize_1 = function $$initialize(native$) {
      var self = this;

      return (self["native"] = native$)
    }, TMP_Event_initialize_1.$$arity = 1);
    
    Opal.def(self, '$to_n', TMP_Event_to_n_2 = function $$to_n() {
      var self = this;

      return self["native"]
    }, TMP_Event_to_n_2.$$arity = 0);
    
    Opal.def(self, '$[]', TMP_Event_$$_3 = function(name) {
      var self = this;

      return self["native"][name]
    }, TMP_Event_$$_3.$$arity = 1);
    
    Opal.def(self, '$type', TMP_Event_type_4 = function $$type() {
      var self = this;

      return self["native"].type
    }, TMP_Event_type_4.$$arity = 0);
    
    Opal.def(self, '$element', TMP_Event_element_5 = function $$element() {
      var self = this;
    ...
    Opal.def(self, '$target', TMP_Event_target_6 = function $$target() {
      var self = this;

      return $(self["native"].target)
    }, TMP_Event_target_6.$$arity = 0);
    
    Opal.def(self, '$prevented?', TMP_Event_prevented$q_7 = function() {
      var self = this;

      return self["native"].isDefaultPrevented()
    }, TMP_Event_prevented$q_7.$$arity = 0);
    
    Opal.def(self, '$prevent', TMP_Event_prevent_8 = function $$prevent() {
      var self = this;

      return self["native"].preventDefault()
    }, TMP_Event_prevent_8.$$arity = 0);
    
    Opal.def(self, '$stopped?', TMP_Event_stopped$q_9 = function() {
      var self = this;

      return self["native"].isPropagationStopped()
    }, TMP_Event_stopped$q_9.$$arity = 0);
    
    Opal.def(self, '$stop', TMP_Event_stop_10 = function $$stop() {
      var self = this;

      return self["native"].stopPropagation()
    }, TMP_Event_stop_10.$$arity = 0);
    
    Opal.def(self, '$stop_immediate', TMP_Event_stop_immediate_11 = function $$stop_immediate() {
      var self = this;

      return self["native"].stopImmediatePropagation()
    }, TMP_Event_stop_immediate_11.$$arity = 0);
    
    Opal.def(self, '$kill', TMP_Event_kill_12 = function $$kill() {
      var self = this;
    ...
    Opal.def(self, '$page_x', TMP_Event_page_x_13 = function $$page_x() {
      var self = this;

      return self["native"].pageX
    }, TMP_Event_page_x_13.$$arity = 0);
    
    Opal.def(self, '$page_y', TMP_Event_page_y_14 = function $$page_y() {
      var self = this;

      return self["native"].pageY
    }, TMP_Event_page_y_14.$$arity = 0);
    
    Opal.def(self, '$touch_x', TMP_Event_touch_x_15 = function $$touch_x() {
      var self = this;

      return self["native"].originalEvent.touches[0].pageX
    }, TMP_Event_touch_x_15.$$arity = 0);
    
    Opal.def(self, '$touch_y', TMP_Event_touch_y_16 = function $$touch_y() {
      var self = this;

      return self["native"].originalEvent.touches[0].pageY
    }, TMP_Event_touch_y_16.$$arity = 0);
    
    Opal.def(self, '$ctrl_key', TMP_Event_ctrl_key_17 = function $$ctrl_key() {
      var self = this;

      return self["native"].ctrlKey
    }, TMP_Event_ctrl_key_17.$$arity = 0);
    
    Opal.def(self, '$meta_key', TMP_Event_meta_key_18 = function $$meta_key() {
      var self = this;

      return self["native"].metaKey
    }, TMP_Event_meta_key_18.$$arity = 0);
    
    Opal.def(self, '$alt_key', TMP_Event_alt_key_19 = function $$alt_key() {
      var self = this;

      return self["native"].altKey
    }, TMP_Event_alt_key_19.$$arity = 0);
    
    Opal.def(self, '$shift_key', TMP_Event_shift_key_20 = function $$shift_key() {
      var self = this;

      return self["native"].shiftKey
    }, TMP_Event_shift_key_20.$$arity = 0);
    
    Opal.def(self, '$key_code', TMP_Event_key_code_21 = function $$key_code() {
      var self = this;

      return self["native"].keyCode
    }, TMP_Event_key_code_21.$$arity = 0);
    
    Opal.def(self, '$which', TMP_Event_which_22 = function $$which() {
      var self = this;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$>>', TMP_Promise_$gt$gt_14 = function(promise) {
      ...
      if ($truthy(self['$exception?']())) {
        ...
        if ($truthy(($truthy($a = self.action['$key?']("failure")['$!']()) ? $a : Opal.const_get_relative($nesting, 'Promise')['$===']((function() {if ($truthy(self.delayed)) {
          return self.delayed['$[]'](0)
        } else {
          return self.error
        }; return nil; })())))) {
    ...
    Opal.def(self, '$resolve!', TMP_Promise_resolve$B_17 = function(value) {
...
if (p == null) p = nil;
    ...
    Opal.def(self, '$reject!', TMP_Promise_reject$B_20 = function(value) {
...
if (p == null) p = nil;
    ...
    Opal.def(self, '$trace!', TMP_Promise_trace$B_29 = function($a_rest) {
...
if (values == null) values = nil;
      ...
      Opal.def(self, '$inject', TMP_When_inject_41 = function $$inject($a_rest) {
...
if (values == null) values = nil;
      ...
      Opal.def(self, '$wait', TMP_When_wait_44 = function $$wait(promise) {
      ...
      Opal.def(self, '$>>', TMP_When_$gt$gt_45 = function($a_rest) {
...
if (action == null) action = nil;
    ...
    Opal.def(self, '$initialize', TMP_HTTP_initialize_6 = function $$initialize() {
      var self = this;
    ...
    Opal.def(self, '$send', TMP_HTTP_send_7 = function $$send(method, url, options, block) {
    ...
    Opal.def(self, '$json', TMP_HTTP_json_8 = function $$json() {
      var $a, self = this;

      return (self.json = ($truthy($a = self.json) ? $a : Opal.const_get_relative($nesting, 'JSON').$parse(self.body)))
    }, TMP_HTTP_json_8.$$arity = 0);
    
    Opal.def(self, '$ok?', TMP_HTTP_ok$q_9 = function() {
      var self = this;

      return self.ok
    }, TMP_HTTP_ok$q_9.$$arity = 0);
    
    Opal.def(self, '$get_header', TMP_HTTP_get_header_10 = function $$get_header(key) {
      var self = this;
    ...
    Opal.def(self, '$inspect', TMP_HTTP_inspect_11 = function $$inspect() {
      var self = this;
    ...
    Opal.def(self, '$promise', TMP_HTTP_promise_14 = function $$promise() {
...
if (res == null) res = nil;
    ...
    Opal.def(self, '$succeed', TMP_HTTP_succeed_15 = function $$succeed(data, status, xhr) {
      var self = this;
    ...
    return (Opal.def(self, '$fail', TMP_HTTP_fail_16 = function $$fail(xhr, status, error) {
      var self = this;
...
Opal.modules["opal/jquery/kernel"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    Opal.def(self, '$alert', TMP_Kernel_alert_1 = function $$alert(msg) {
      var self = this;
...
Opal.modules["text"] = function(Opal) {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2, $truthy = Opal.truthy, $hash = Opal.hash;

  Opal.add_stubs(['$attr_accessor', '$new', '$now', '$+', '$-', '$sec', '$*', '$%', '$min', '$hour', '$mindex', '$to_f', '$def_hours', '$quick_fire?', '$pin', '$code', '$strftime', '$date_from', '$date_to', '$display_name', '$[]', '$sanity_day', '$>=', '$>', '$count', '$pin_codes', '$name', '$!', '$sanity?', '$yday', '$<', '$===', '$include?', '$sanity', '$sms_message', '$hour_from', '$/', '$min_from', '$day_from', '$delta', '$date_today', '$year', '$month', '$day', '$hour_to', '$min_to', '$day_to', '$<=', '$capitalize', '$start_of_day']);
  return (function($base, $super, $parent_nesting) {
    function $Text(){};
    var self = $Text = $klass($base, $super, 'Text', $Text);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Text_initialize_1, TMP_Text_sms_message_2, TMP_Text_sanity_3, TMP_Text_dates_wonky$q_4, TMP_Text_display_name_5, TMP_Text_sanity$q_6, TMP_Text_sanity_day_7, TMP_Text_quick_fire$q_8, TMP_Text_full_message_9, TMP_Text_date_from_10, TMP_Text_date_to_11, TMP_Text_from_datepicker_title_12, TMP_Text_to_datepicker_title_13, TMP_Text_date_today_14, TMP_Text_mindex_15;
    ...
    Opal.def(self, '$initialize', TMP_Text_initialize_1 = function $$initialize() {
      var self = this, t = nil, time_to = nil;

      
      self.pin_code = Opal.const_get_relative($nesting, 'PinCode').$new();
      ...
      self.min_from = self.$mindex(self.time.$min());
      time_to = $rb_plus(self.time, $rb_times($rb_times(60, 60), Opal.const_get_relative($nesting, 'Settings').$def_hours().$to_f()));
      self.hour_to = time_to.$hour();
      return (self.min_to = self.$mindex(time_to.$min()));
    }, TMP_Text_initialize_1.$$arity = 0);
    
    Opal.def(self, '$sms_message', TMP_Text_sms_message_2 = function $$sms_message() {
      var self = this;

      if ($truthy(self['$quick_fire?']())) {
        return "" + (self.pin_code.$pin()) + " " + (self.$code())
      } else {
        return "" + (self.pin_code.$pin()) + " " + (self.$date_from().$strftime("%d%m%y")) + " " + (self.$date_from().$strftime("%H%M")) + " " + (self.$date_to().$strftime("%d%m%y")) + " " + (self.$date_to().$strftime("%H%M")) + " " + (self.$code())
      }
    }, TMP_Text_sms_message_2.$$arity = 0);
    
    Opal.def(self, '$sanity', TMP_Text_sanity_3 = function $$sanity() {
    ...
    Opal.def(self, '$dates_wonky?', TMP_Text_dates_wonky$q_4 = function() {
      var self = this;

      return $rb_ge(self.$date_from(), self.$date_to())
    }, TMP_Text_dates_wonky$q_4.$$arity = 0);
    
    Opal.def(self, '$display_name', TMP_Text_display_name_5 = function $$display_name() {
      var self = this;

      if ($truthy($rb_gt(Opal.const_get_relative($nesting, 'Settings').$pin_codes().$count(), 1))) {
        return self.pin_code.$name()
      } else {
        return nil
      }
    }, TMP_Text_display_name_5.$$arity = 0);
    
    Opal.def(self, '$sanity?', TMP_Text_sanity$q_6 = function() {
      var $a, self = this;

      return ($truthy($a = self['$quick_fire?']()['$!']()) ? Opal.const_get_relative($nesting, 'Settings')['$sanity?']() : $a)
    }, TMP_Text_sanity$q_6.$$arity = 0);
    
    Opal.def(self, '$sanity_day', TMP_Text_sanity_day_7 = function $$sanity_day(in_date) {
    ...
    }, TMP_Text_sanity_day_7.$$arity = 1);
    
    Opal.def(self, '$quick_fire?', TMP_Text_quick_fire$q_8 = function() {
      var self = this;

      return ["ON", "OFF"]['$include?'](self.$code())
    }, TMP_Text_quick_fire$q_8.$$arity = 0);
    
    Opal.def(self, '$full_message', TMP_Text_full_message_9 = function $$full_message(in_code) {
      var self = this;

      return $rb_plus($rb_plus(self.$sanity(), "\n\n"), self.$sms_message(in_code))
    }, TMP_Text_full_message_9.$$arity = 1);
    
    Opal.def(self, '$date_from', TMP_Text_date_from_10 = function $$date_from() {
      var self = this, from_hours = nil, now_hours = nil, diff_hours = nil, date = nil;

      
      from_hours = $rb_plus(self.$hour_from().$to_f(), $rb_divide(self.$min_from().$to_f(), 4));
    ...
    }, TMP_Text_date_from_10.$$arity = 0);
    
    Opal.def(self, '$date_to', TMP_Text_date_to_11 = function $$date_to() {
      var self = this, to_hours = nil, then_hours = nil, diff_hours = nil, date = nil;

      
      to_hours = $rb_plus(self.$hour_to().$to_f(), $rb_divide(self.$min_to().$to_f(), 4));
    ...
    }, TMP_Text_date_to_11.$$arity = 0);
    
    Opal.def(self, '$from_datepicker_title', TMP_Text_from_datepicker_title_12 = function $$from_datepicker_title() {
      var self = this;
    ...
    }, TMP_Text_from_datepicker_title_12.$$arity = 0);
    
    Opal.def(self, '$to_datepicker_title', TMP_Text_to_datepicker_title_13 = function $$to_datepicker_title() {
      var self = this;
    ...
    }, TMP_Text_to_datepicker_title_13.$$arity = 0);
    
    Opal.def(self, '$date_today', TMP_Text_date_today_14 = function $$date_today() {
      var self = this;

      return Opal.const_get_relative($nesting, 'Time').$new().$start_of_day()
    }, TMP_Text_date_today_14.$$arity = 0);
    return (Opal.def(self, '$mindex', TMP_Text_mindex_15 = function $$mindex(mins) {
      var self = this;

      
      $hash(0, 0, 15, 1, 30, 2, 45, 3)['$[]'](mins);
      return mins;
    }, TMP_Text_mindex_15.$$arity = 1), nil) && 'mindex';
  })($nesting[0], null, $nesting)
};

/* Generated by Opal 0.11.1.dev */
Opal.modules["settings"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  function $rb_gt(lhs, rhs) {
  ...
  Opal.add_stubs(['$[]', '$user_defaults', '$nil?', '$[]=', '$-', '$>', '$to_f', '$to_s', '$/', '$round', '$*', '$length', '$pin_codes', '$sms_number', '$!=', '$!', '$empty?', '$web_user', '$web_pass', '$web_url', '$sanity_check', '$sms_check']);
  return (function($base, $super, $parent_nesting) {
    function $Settings(){};
    var self = $Settings = $klass($base, $super, 'Settings', $Settings);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Settings_sms_number_1, TMP_Settings_pin_codes_2, TMP_Settings_def_hours_3, TMP_Settings_web_user_4, TMP_Settings_web_pass_5, TMP_Settings_web_url_6, TMP_Settings_cust_code_7, TMP_Settings_sanity_check_8, TMP_Settings_sms_check_9, TMP_Settings_sms_number$eq_10, TMP_Settings_web_user$eq_11, TMP_Settings_web_pass$eq_12, TMP_Settings_web_url$eq_13, TMP_Settings_cust_code$eq_14, TMP_Settings_pin_codes$eq_15, TMP_Settings_def_hours$eq_16, TMP_Settings_sanity_check$eq_17, TMP_Settings_sms_check$eq_18, TMP_Settings_user_defaults_19, TMP_Settings_setup$q_20, TMP_Settings_fsiweb_setup$q_21, TMP_Settings_sanity$q_22, TMP_Settings_sms_check$q_23;

    
    Opal.defs(self, '$sms_number', TMP_Settings_sms_number_1 = function $$sms_number() {
      var self = this;

      return self.$user_defaults()['$[]']("sms_number")
    }, TMP_Settings_sms_number_1.$$arity = 0);
    Opal.defs(self, '$pin_codes', TMP_Settings_pin_codes_2 = function $$pin_codes() {
      var $a, self = this;

      return ($truthy($a = self.$user_defaults()['$[]']("pin_codes")) ? $a : ["Me:00000"])
    }, TMP_Settings_pin_codes_2.$$arity = 0);
    Opal.defs(self, '$def_hours', TMP_Settings_def_hours_3 = function $$def_hours() {
      var $a, self = this;

      return ($truthy($a = self.$user_defaults()['$[]']("def_hours")) ? $a : "1")
    }, TMP_Settings_def_hours_3.$$arity = 0);
    Opal.defs(self, '$web_user', TMP_Settings_web_user_4 = function $$web_user() {
      var $a, self = this;

      return ($truthy($a = self.$user_defaults()['$[]']("web_user")) ? $a : "")
    }, TMP_Settings_web_user_4.$$arity = 0);
    Opal.defs(self, '$web_pass', TMP_Settings_web_pass_5 = function $$web_pass() {
      var $a, self = this;

      return ($truthy($a = self.$user_defaults()['$[]']("web_pass")) ? $a : "")
    }, TMP_Settings_web_pass_5.$$arity = 0);
    Opal.defs(self, '$web_url', TMP_Settings_web_url_6 = function $$web_url() {
      var $a, self = this;

      return ($truthy($a = self.$user_defaults()['$[]']("web_url")) ? $a : "")
    }, TMP_Settings_web_url_6.$$arity = 0);
    Opal.defs(self, '$cust_code', TMP_Settings_cust_code_7 = function $$cust_code() {
      var $a, self = this;

      return ($truthy($a = self.$user_defaults()['$[]']("cust_code")) ? $a : "T")
    }, TMP_Settings_cust_code_7.$$arity = 0);
    Opal.defs(self, '$sanity_check', TMP_Settings_sanity_check_8 = function $$sanity_check() {
      var self = this;

      if ($truthy(self.$user_defaults()['$[]']("sanity_check")['$nil?']())) {
        return true
      } else {
        return self.$user_defaults()['$[]']("sanity_check")
      }
    }, TMP_Settings_sanity_check_8.$$arity = 0);
    Opal.defs(self, '$sms_check', TMP_Settings_sms_check_9 = function $$sms_check() {
      var self = this;

      if ($truthy(self.$user_defaults()['$[]']("sms_check")['$nil?']())) {
        return true
      } else {
        return self.$user_defaults()['$[]']("sms_check")
      }
    }, TMP_Settings_sms_check_9.$$arity = 0);
    Opal.defs(self, '$sms_number=', TMP_Settings_sms_number$eq_10 = function(string) {
      var self = this, $writer = nil;

      
      $writer = ["sms_number", string];
      $send(self.$user_defaults(), '[]=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];
    }, TMP_Settings_sms_number$eq_10.$$arity = 1);
    Opal.defs(self, '$web_user=', TMP_Settings_web_user$eq_11 = function(string) {
      var self = this, $writer = nil;

      
      $writer = ["web_user", string];
      $send(self.$user_defaults(), '[]=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];
    }, TMP_Settings_web_user$eq_11.$$arity = 1);
    Opal.defs(self, '$web_pass=', TMP_Settings_web_pass$eq_12 = function(string) {
      var self = this, $writer = nil;

      
      $writer = ["web_pass", string];
      $send(self.$user_defaults(), '[]=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];
    }, TMP_Settings_web_pass$eq_12.$$arity = 1);
    Opal.defs(self, '$web_url=', TMP_Settings_web_url$eq_13 = function(string) {
      var self = this, $writer = nil;

      
      $writer = ["web_url", string];
      $send(self.$user_defaults(), '[]=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];
    }, TMP_Settings_web_url$eq_13.$$arity = 1);
    Opal.defs(self, '$cust_code=', TMP_Settings_cust_code$eq_14 = function(string) {
      var self = this, $writer = nil;

      
      $writer = ["cust_code", string];
      $send(self.$user_defaults(), '[]=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];
    }, TMP_Settings_cust_code$eq_14.$$arity = 1);
    Opal.defs(self, '$pin_codes=', TMP_Settings_pin_codes$eq_15 = function(codes) {
      var self = this, $writer = nil;

      
      $writer = ["pin_codes", codes];
      $send(self.$user_defaults(), '[]=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];
    }, TMP_Settings_pin_codes$eq_15.$$arity = 1);
    Opal.defs(self, '$def_hours=', TMP_Settings_def_hours$eq_16 = function(string) {
      var self = this, $writer = nil;

      
      $writer = ["def_hours", (function() {if ($truthy($rb_gt(string.$to_f(), 24))) {
        return "24"
      } else {
        return $rb_divide($rb_times(string.$to_f(), 4).$round(), 4.0).$to_s()
      }; return nil; })()];
      $send(self.$user_defaults(), '[]=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];
    }, TMP_Settings_def_hours$eq_16.$$arity = 1);
    Opal.defs(self, '$sanity_check=', TMP_Settings_sanity_check$eq_17 = function(string) {
      var self = this, $writer = nil;

      
      $writer = ["sanity_check", string];
      $send(self.$user_defaults(), '[]=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];
    }, TMP_Settings_sanity_check$eq_17.$$arity = 1);
    Opal.defs(self, '$sms_check=', TMP_Settings_sms_check$eq_18 = function(string) {
      var self = this, $writer = nil;

      
      $writer = ["sms_check", string];
      $send(self.$user_defaults(), '[]=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];
    }, TMP_Settings_sms_check$eq_18.$$arity = 1);
    Opal.defs(self, '$user_defaults', TMP_Settings_user_defaults_19 = function $$user_defaults() {
      var $a, self = this;
      if (self.defaults == null) self.defaults = nil;

      return (self.defaults = ($truthy($a = self.defaults) ? $a : $hash2([], {})))
    }, TMP_Settings_user_defaults_19.$$arity = 0);
    Opal.defs(self, '$setup?', TMP_Settings_setup$q_20 = function() {
      var $a, $b, self = this;

      return ($truthy($a = ($truthy($b = $rb_gt(self.$pin_codes().$length(), 0)) ? self.$sms_number() : $b)) ? self.$pin_codes()['$[]'](0)['$!=']("Me:00000") : $a)
    }, TMP_Settings_setup$q_20.$$arity = 0);
    Opal.defs(self, '$fsiweb_setup?', TMP_Settings_fsiweb_setup$q_21 = function() {
      var $a, $b, self = this;

      return ($truthy($a = ($truthy($b = self.$web_user()['$empty?']()['$!']()) ? self.$web_pass()['$empty?']()['$!']() : $b)) ? self.$web_url()['$empty?']()['$!']() : $a)
    }, TMP_Settings_fsiweb_setup$q_21.$$arity = 0);
    Opal.defs(self, '$sanity?', TMP_Settings_sanity$q_22 = function() {
      var self = this;

      return self.$sanity_check()
    }, TMP_Settings_sanity$q_22.$$arity = 0);
    return (Opal.defs(self, '$sms_check?', TMP_Settings_sms_check$q_23 = function() {
      var self = this;

      return self.$sms_check()
    }, TMP_Settings_sms_check$q_23.$$arity = 0), nil) && 'sms_check?';
  })($nesting[0], null, $nesting)
};

/* Generated by Opal 0.11.1.dev */
Opal.modules["pin_code"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$attr_accessor']);
  return (function($base, $super, $parent_nesting) {
    function $PinCode(){};
    var self = $PinCode = $klass($base, $super, 'PinCode', $PinCode);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_PinCode_pin_1, TMP_PinCode_name_2;

    
    self.$attr_accessor("pin_code_data");
    
    Opal.def(self, '$pin', TMP_PinCode_pin_1 = function $$pin() {
      var self = this;

      return "52226"
    }, TMP_PinCode_pin_1.$$arity = 0);
    return (Opal.def(self, '$name', TMP_PinCode_name_2 = function $$name() {
      var self = this;

      return "me"
    }, TMP_PinCode_name_2.$$arity = 0), nil) && 'name';
  })($nesting[0], null, $nesting)
};
