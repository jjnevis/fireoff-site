...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$ready?', '$height', '$width', '$new', '$find', '$[]', '$value=', '$-', '$css', '$/', '$on', '$forward_url', '$text', '$element', '$sms_message', '$text=', '$hour_from', '$min_from', '$hour_to', '$min_to', '$hour_from=', '$min_from=', '$hour_to=', '$min_to=', '$update_static_data', '$value', '$pin_code=', '$code=', '$[]=']);
  ...
  return $send(Opal.const_get_relative($nesting, 'Document'), 'ready?', [], (TMP_1 = function(){var self = TMP_1.$$s || this, $a, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_forward_url_8, TMP_update_static_data_9, $writer = nil;
    ...
    $writer[$rb_minus($writer["length"], 1)];;
    Opal.const_get_relative($nesting, 'Element').$find("#tel").$css("font-size", "" + ($rb_divide(self.width, 14)) + "px");
    Opal.const_get_relative($nesting, 'Element').$find("#tel").$css("width", "" + ($rb_divide(self.width, 2)) + "px");
    Opal.const_get_relative($nesting, 'Element').$find("#pin").$css("font-size", "" + ($rb_divide(self.width, 14)) + "px");
...
if (event == null) event = nil;
    ...
    $send(Opal.const_get_relative($nesting, 'Element').$find(".fh"), 'on', ["click"], (TMP_3 = function(event){var self = TMP_3.$$s || this;
      if (self.text == null) self.text = nil;
      if (self.debug == null) self.debug = nil;
if (event == null) event = nil;
    ...
    $send(Opal.const_get_relative($nesting, 'Element').$find(".fm"), 'on', ["click"], (TMP_4 = function(event){var self = TMP_4.$$s || this;
      if (self.text == null) self.text = nil;
      if (self.debug == null) self.debug = nil;
if (event == null) event = nil;
    ...
    $send(Opal.const_get_relative($nesting, 'Element').$find(".th"), 'on', ["click"], (TMP_5 = function(event){var self = TMP_5.$$s || this;
      if (self.text == null) self.text = nil;
      if (self.debug == null) self.debug = nil;
if (event == null) event = nil;
    ...
    $send(Opal.const_get_relative($nesting, 'Element').$find(".tm"), 'on', ["click"], (TMP_6 = function(event){var self = TMP_6.$$s || this;
      if (self.text == null) self.text = nil;
      if (self.debug == null) self.debug = nil;
if (event == null) event = nil;
...
if (event == null) event = nil;
    ...
    Opal.def(self, '$forward_url', TMP_forward_url_8 = function $$forward_url(code) {
    ...
    }, TMP_forward_url_8.$$arity = 1);
    return (Opal.def(self, '$update_static_data', TMP_update_static_data_9 = function $$update_static_data() {
      var self = this, $writer = nil;

      
      
      $writer = ["tel", Opal.const_get_relative($nesting, 'Element').$find("#tel").$value()];
      $send(Opal.const_get_relative($nesting, 'LocalStorage'), '[]=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      
      $writer = ["pin", Opal.const_get_relative($nesting, 'Element').$find("#pin").$value()];
      $send(Opal.const_get_relative($nesting, 'LocalStorage'), '[]=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];;
    }, TMP_update_static_data_9.$$arity = 0), nil) && 'update_static_data';}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1));
})(Opal);
