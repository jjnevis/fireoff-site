...
Opal.modules["corelib/module"] = function(Opal) {
  ...
  Opal.add_stubs(['$===', '$raise', '$equal?', '$<', '$>', '$nil?', '$attr_reader', '$attr_writer', '$class_variable_name!', '$new', '$const_name!', '$=~', '$inject', '$split', '$const_get', '$==', '$!~', '$start_with?', '$to_proc', '$lambda', '$bind', '$call', '$class', '$append_features', '$included', '$name', '$cover?', '$size', '$merge', '$compile', '$proc', '$any?', '$to_s', '$__id__', '$constants', '$include?', '$copy_class_variables', '$copy_constants']);
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$remove_class_variable', TMP_Module_remove_class_variable_21 = function $$remove_class_variable(name) {
      ...
      if (Opal.hasOwnProperty.call(self.$$cvars, name)) {
        ...
        self.$raise(Opal.const_get_relative($nesting, 'NameError'), "" + "cannot remove " + (name) + " for " + (self))
      }
    ;
...
if (o == null) o = nil;if (c == null) c = nil;
    ...
    Opal.def(self, '$module_eval', TMP_Module_module_eval_45 = function $$module_eval($a_rest) {
      ...
      if ($truthy(($truthy($b = block['$nil?']()) ? !!Opal.compile : $b))) {
        ...
        Opal.const_get_relative($nesting, 'Kernel').$raise(Opal.const_get_relative($nesting, 'ArgumentError'), "" + ("" + "wrong number of arguments (" + (args.$size()) + " for 0)") + "\n\n  NOTE:If you want to enable passing a String argument please add \"require 'opal-parser'\" to your script\n")};
...
Opal.modules["corelib/basic_object"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return (Opal.def(self, '$method_missing', TMP_BasicObject_method_missing_14 = function $$method_missing(symbol, $a_rest) {
      ...
      return Opal.const_get_qualified('::', 'Kernel').$raise(Opal.const_get_qualified('::', 'NoMethodError').$new(message, symbol));
...
if (obj == null) obj = nil;
    ...
    Opal.def(self, '$raise', TMP_Kernel_raise_50 = function $$raise(exception, string, _backtrace) {
      ...
      else if (exception['$is_a?'](Opal.const_get_relative($nesting, 'Exception'))) {
        // exception is fine
      }
      else {
    ...
    Opal.def(self, '$throw', TMP_Kernel_throw_65 = function($a_rest) {
      ...
      return self.$raise(Opal.const_get_relative($nesting, 'UncaughtThrowError'), args)
...
Opal.modules["corelib/enumerable"] = function(Opal) {
  ...
  Opal.add_stubs(['$each', '$public_send', '$destructure', '$to_enum', '$enumerator_size', '$new', '$yield', '$raise', '$slice_when', '$!', '$enum_for', '$flatten', '$map', '$warn', '$proc', '$==', '$nil?', '$respond_to?', '$coerce_to!', '$>', '$*', '$coerce_to', '$try_convert', '$<', '$+', '$-', '$ceil', '$/', '$size', '$__send__', '$length', '$<=', '$[]', '$push', '$<<', '$[]=', '$===', '$inspect', '$<=>', '$first', '$reverse', '$sort', '$to_proc', '$compare', '$call', '$dup', '$to_a', '$lambda', '$sort!', '$map!', '$key?', '$values', '$zip']);
  return (function($base, $parent_nesting) {
    ...
    Opal.def(self, '$sum', TMP_Enumerable_sum_98 = function $$sum(initial) {
      ...
      $send(self, 'each', [], (TMP_97 = function($a_rest){var self = TMP_97.$$s || this, args, item = nil;
        ...
        item = (function() {if (($yield !== nil)) {
          ...
          return Opal.const_get_relative($nesting, 'Opal').$destructure(args)
        }; return nil; })();
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$with_index', TMP_Enumerator_with_index_5 = function $$with_index(offset) {
      ...
      offset = (function() {if ($truthy(offset)) {
        return Opal.const_get_relative($nesting, 'Opal').$coerce_to(offset, Opal.const_get_relative($nesting, 'Integer'), "to_int")
      } else {
        return 0
      }; return nil; })();
      if ($truthy(block)) {
...
Opal.modules["corelib/array"] = function(Opal) {
  ...
  ;
    ...
    Opal.def(self, '$&', TMP_Array_$_4 = function(other) {
      ...
      other = (function() {if ($truthy(Opal.const_get_relative($nesting, 'Array')['$==='](other))) {
        return other.$to_a()
      } else {
        return Opal.const_get_relative($nesting, 'Opal').$coerce_to(other, Opal.const_get_relative($nesting, 'Array'), "to_ary").$to_a()
      }; return nil; })();
  ...
  ;
    ...
    Opal.def(self, '$[]=', TMP_Array_$$$eq_13 = function(index, value, extra) {
      ...
      if ($truthy(Opal.const_get_relative($nesting, 'Range')['$==='](index))) {
        ...
        data = (function() {if ($truthy(Opal.const_get_relative($nesting, 'Array')['$==='](value))) {
          return value.$to_a()
  ...
  ;
    ...
    Opal.def(self, '$sample', TMP_Array_sample_89 = function $$sample(count, options) {
      ...
      rng = (function() {if ($truthy(($truthy($a = rng) ? rng['$respond_to?']("rand") : $a))) {
        return Opal.const_get_relative($nesting, 'SampleRandom').$new(rng)
      } else {
        return Opal.const_get_relative($nesting, 'Kernel')
      }; return nil; })();
      if ($truthy(count)) {
      } else {
...
if (row == null) row = nil;
        ...
        row = (function() {if ($truthy(Opal.const_get_relative($nesting, 'Array')['$==='](row))) {
          return row.$to_a()
        } else {
          return Opal.const_get_relative($nesting, 'Opal').$coerce_to(row, Opal.const_get_relative($nesting, 'Array'), "to_ary").$to_a()
        }; return nil; })();
...
if (elem == null) elem = nil;
      if ($truthy(elem['$is_a?'](Opal.const_get_relative($nesting, 'Range')))) {
...
Opal.modules["corelib/range"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$size', TMP_Range_size_12 = function $$size() {
      ...
      if ($truthy(($truthy($a = Opal.const_get_relative($nesting, 'Numeric')['$==='](range_begin)) ? Opal.const_get_relative($nesting, 'Numeric')['$==='](range_end) : $a))) {
      } else {
        return nil
      };
...
Opal.modules["corelib/complex"] = function(Opal) {
  ...
  (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$to_s', TMP_Complex_to_s_31 = function $$to_s() {
      ...
      result = $rb_plus(result, (function() {if ($truthy(($truthy($a = ($truthy($b = ($truthy($c = Opal.const_get_relative($nesting, 'Number')['$==='](self.imag)) ? self.imag['$nan?']() : $c)) ? $b : self.imag['$positive?']())) ? $a : self.imag['$zero?']()))) {
        return "+"
      } else {
        return "-"
      }; return nil; })());
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return (function(self, $parent_nesting) {
      ...
      Opal.def(self, '$expand_path', TMP_expand_path_1 = function $$expand_path(path, basedir) {
        ...
        basedir = ($truthy($a = basedir) ? $a : Opal.const_get_relative($nesting, 'Dir').$pwd());
...
if (item == null) item = nil;if (index == null) index = nil;
          ...
          if ($truthy(next_item['$nil?']())) {
            ...
            return (result = (function() {if ($truthy(($truthy($a = item['$end_with?'](Opal.const_get_relative($nesting, 'SEPARATOR'))) ? $a : next_item['$start_with?'](Opal.const_get_relative($nesting, 'SEPARATOR'))))) {
              return "" + (result) + (item)
            } else {
              return "" + (result) + (item) + (Opal.const_get_relative($nesting, 'SEPARATOR'))
            }; return nil; })());
...
Opal.modules["corelib/random"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.defs(self, '$urandom', TMP_Random_urandom_7 = function $$urandom(size) {
      ...
      return $send(Opal.const_get_relative($nesting, 'Array'), 'new', [size], (TMP_6 = function(){var self = TMP_6.$$s || this;
    ...
    Opal.def(self, '$bytes', TMP_Random_bytes_10 = function $$bytes(length) {
      ...
      length = Opal.const_get_relative($nesting, 'Opal')['$coerce_to!'](length, Opal.const_get_relative($nesting, 'Integer'), "to_int");
      return $send(Opal.const_get_relative($nesting, 'Array'), 'new', [length], (TMP_9 = function(){var self = TMP_9.$$s || this;
